...
FOR EACH ROW
BEGIN
	if(!((SELECT a.cupo-count(au.idUsuario) FROM actgrupalusuario au, actividadgrupal a WHERE au.idActGrupal = 1 and a.idActividadGrupal=au.idActGrupal)>0))
    then
